...
class ShannonEntropyMetric(Metric):
    """
...
class PairwiseDistanceMetric(Metric):
    ...
    def pairwise_euclidean_distances(self, ts: TensorLike) -> TensorLike:
        """
    ...
    def __call__(self, d: tsgm.dataset.DatasetOrTensor) -> TensorLike:
        """
